...
final class FragmentState implements Parcelable {
    ...
    //mArguments会被保存下来，因此必须使用规范的编码方式
    final Bundle mArguments;

    /** Fragment的数据状态和View状态，保存之后不可能为Null，
     * 因为这个里面至少会保存它的Target Fragment的Index */
...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    static final int CREATED = 1;          // Created.【Activity onCreate的时候，在数据恢复之后】
    static final int ACTIVITY_CREATED = 2; // The activity has finished its creation.【start之后】
    ...
    Bundle mSavedFragmentState;
    /** 保存Fragment的View状态（还记得View的保存么？），
     * 这个值最后也是保存在mSavedFragmentState里面的 */
     ...
     */
    //时机很重要：在onStop和onDestroy之间，在内部则在状态被保存以及从parent之间
    ...
    */
    ...
    void performSaveInstanceState(Bundle outState) {
        //这里表明onSaveInstanceState中怎么写都没有关系
